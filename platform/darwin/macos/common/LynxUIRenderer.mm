...
LynxUIRendererImpl::LynxUIRendererImpl(lynx_view_builder_t* builder)
  ...
  if (builder->generic_fetcher) {
    ...
    [lynx_ui_renderer.clayViewProvider setInterceptUrlCallback:^NSString*(
         NSString* originUrl, BOOL shouldDecode, NSInteger maxPathLength) {
      ...
      NSLog(@"LynxUIRendererMac intercept origin=%@ redirected=%@",
            originUrl, redirectedUrl ?: @"");
