...
// clang-format off
#ifndef CORE_RUNTIME_LEPUSNG_NAPI_WORKLET_NAPI_LEPUS_ELEMENT_H_
#define CORE_RUNTIME_LEPUSNG_NAPI_WORKLET_NAPI_LEPUS_ELEMENT_H_
...
#endif  // CORE_RUNTIME_LEPUSNG_NAPI_WORKLET_NAPI_LEPUS_ELEMENT_H_
